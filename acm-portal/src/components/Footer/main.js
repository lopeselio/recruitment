...
export default class Footer extends Component {
    render() {
        return ( <div className = 'footerContent' >
            ...
            <a className = 'fb'
            target = "blank"
            href = "https://www.facebook.com/ACM.VITU/" > < img className = 'sm'
            src = { facebook } > </img></a >

            <a className = 'git'
            target = "blank"
            href = "https://github.com/ACM-VIT" > < img className = 'sm'
            src = { github } > </img></a >
            ...
            <Grid className = 'vitLogo'
            item xs = { 12 }
            md = { 4 } >
            <div className = 'vitlg' >
            <img className = 'vitl'
            src = { vit } > </img> </div> </Grid>
